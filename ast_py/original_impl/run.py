...
from ast_py.original_impl import ast_ge
...
def run():
    input = "/Users/eduardo/PycharmProjects/TwoLevelGenericASTProject/codenet_dataset/py_skipgram_dataset/**.py"
    output = "/Users/eduardo/PycharmProjects/TwoLevelGenericASTProject/ast_py/fine_generic_impl/py_skipgram"
    loglevel = logging.INFO
    logging.basicConfig(level=loglevel)
    batch = False

    if batch:
        options = {"min_nodes": 20, "max_nodes": 50000, "normalize": True}
        process_files(input, output, options)
    else:
        success = run_parse_file("/Users/eduardo/PycharmProjects/TwoLevelGenericASTProject/codenet_dataset/py_skipgram_dataset/s181066699.py")
