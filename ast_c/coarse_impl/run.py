...
from ast_c.utils import glob
from ast_c.coarse_impl import ast_ge
from ast_c.utils.queue_item import FailedFileItem, ProcessedFileItem
...
def process_file(filename):
    ...
    try:
        ast = ast_ge.parse_file(filename)
...
def run():
    input = "/Users/eduardo/PycharmProjects/TwoLevelGenericASTProject/model_2level/atcoder_307_c/**.c"
    output = "/Users/eduardo/PycharmProjects/TwoLevelGenericASTProject/model_2level/atcoder_c/atcoder_c_coarse"
    loglevel = logging.INFO
    logging.basicConfig(level=loglevel)
    # options = {"min_nodes": 20, "max_nodes": 30000}
    options = {"min_nodes": 0, "max_nodes": 30000}
